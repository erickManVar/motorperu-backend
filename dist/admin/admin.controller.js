...
let AdminController = class AdminController {
    ...
    approve(userId) { return this.adminService.approveProvider(userId); }
    suspend(userId) { return this.adminService.suspendProvider(userId); }
...
__decorate([
    (0, common_1.Patch)('verifications/:userId/approve'),
...
__decorate([
    (0, common_1.Patch)('verifications/:userId/suspend'),
    __param(0, (0, common_1.Param)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.Patch)('disputes/:bookingId/resolve'),
